        ...
        <div className="flex h-full flex-col">
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                className="flex h-12 w-12 items-center justify-center rounded-2xl bg-accent shadow-card"
                style={{ color: "rgb(var(--color-on-accent))" }}
              >
                <WalletCards size={20} />
              </div>
              <div>
          ...
          <div className="mb-6 rounded-3xl border border-accent/30 bg-accent px-4 py-4 shadow-card">
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-white/75 dark:text-[rgb(var(--color-on-accent))]/75">
              Current access
            </p>
            <div className="mt-3 flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-white dark:text-[rgb(var(--color-on-accent))]">
                  {user?.name || "System User"}
                </p>
                <p className="text-sm text-white/80 dark:text-[rgb(var(--color-on-accent))]/80">
                  {role || "Guest"}
                </p>
              </div>
            </div>
          ...
          <p className="mb-3 px-3 text-xs font-bold uppercase tracking-[0.25em] text-muted">
            Workspace
          </p>
          ...
          <div className="mt-auto space-y-4 pt-8">
            ...
            <button
              type="button"
              onClick={() => logout()}
              className="nav-pill w-full justify-start border border-line bg-surface"
            >
